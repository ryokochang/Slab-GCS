            ...
            foreach (var port in MainV2.Comports.ToArray())
            {
                foreach (var mav in port.MAVlist)
                {
                    ...
                    try
                    {
                        ...
                        // add offsets to utm
                        p1[0] += x*Math.Cos(MathHelpers.DegreesToRadians(heading)) - y*Math.Sin(MathHelpers.DegreesToRadians(heading));
                        p1[1] += x*Math.Sin(MathHelpers.DegreesToRadians(heading)) + y*Math.Cos(MathHelpers.DegreesToRadians(heading));
                        ...
                        if (mav.cs.firmware == MainV2.Firmwares.ArduPlane)
                        {
                            ...
                            p1[1] += gs*Math.Cos(MathHelpers.DegreesToRadians((-heading)));
                            p1[0] += gs*Math.Sin(MathHelpers.DegreesToRadians((-heading)));
                        }
