    ...
    public partial class FormationControl : Form
    {
        ...
        public HIL.Vector3 getOffsetFromLeader(MAVState leader, MAVState mav)
        {
           ...
           var norotation = new HIL.Vector3(masterutm[1] - mavutm[1], masterutm[0] - mavutm[0], 0);
            ...
            return new HIL.Vector3( norotation.x * Math.Cos(MathHelpers.DegreesToRadians(heading)) - norotation.y * Math.Sin(MathHelpers.DegreesToRadians(heading)), norotation.x * Math.Sin(MathHelpers.DegreesToRadians(heading)) + norotation.y * Math.Cos(MathHelpers.DegreesToRadians(heading)), 0);
        }
