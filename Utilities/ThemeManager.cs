...
> <Grid>";
        ...
        private static void SetBurntKermitColors()
        {
            ...
            ButBG = Color.LightBlue;                           // This changes the colour of button backgrounds (Top)
            ButBGBot = Color.White;                       // This changes the colour of button backgrounds (Bot)
            ProgressBarColorTop = Color.LightBlue;             // These three variables change the colours of progress bars
            ProgressBarColorBot = Color.White;
            ProgressBarOutlineColor = Color.FromArgb(150, 174, 112);
            BannerColor1 = Color.LightBlue;                // These two variables change the colours of banners such as "planner" umder configuration
            BannerColor2 = Color.White;
