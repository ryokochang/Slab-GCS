...
namespace MissionPlanner
{
    public partial class GridUI : Form
    {
        ...
        public GridUI(GridPlugin plugin)
        {
            ...
            CMB_startfrom1.DataSource = Enum.GetNames(typeof (Grid.StartPosition));
            CMB_startfrom1.SelectedIndex = 0;
        ...
        void loadgriddata(GridData griddata)
        {
            ...
            NUM_Distance1.Value = griddata.dist;
            NUM_overshoot1.Value = griddata.overshoot1;
            NUM_overshoot21.Value = griddata.overshoot2;
            NUM_leadin1.Value = griddata.leadin;
            CMB_startfrom1.Text = griddata.startfrom;
            num_overlap1.Value = griddata.overlap;
            num_sidelap1.Value = griddata.sidelap;
        ...
        GridData savegriddata()
        {
            ...
            griddata.autotakeoff_RTL = false;
            ...
            griddata.dist = NUM_Distance1.Value;
            griddata.overshoot1 = NUM_overshoot1.Value;
            griddata.overshoot2 = NUM_overshoot21.Value;
            griddata.leadin = NUM_leadin1.Value;
            griddata.startfrom = CMB_startfrom1.Text;
            griddata.overlap = num_overlap1.Value;
            griddata.sidelap = num_sidelap1.Value;
        ...
        void loadsettings()
        {
            if (plugin.Host.config.ContainsKey("grid_camera"))
            {
                ...
                loadsetting("grid_dist", NUM_Distance1);
                loadsetting("grid_overshoot1", NUM_overshoot1);
                loadsetting("grid_overshoot2", NUM_overshoot21);
                loadsetting("grid_leadin", NUM_leadin1);
                loadsetting("grid_startfrom", CMB_startfrom1);
                loadsetting("grid_overlap", num_overlap1);
                loadsetting("grid_sidelap", num_sidelap1);
        ...
        void savesettings()
        {
            ...
            plugin.Host.config["grid_dist"] = NUM_Distance1.Value.ToString();
            plugin.Host.config["grid_overshoot1"] = NUM_overshoot1.Value.ToString();
            plugin.Host.config["grid_overshoot2"] = NUM_overshoot21.Value.ToString();
            plugin.Host.config["grid_leadin"] = NUM_leadin1.Value.ToString();
            plugin.Host.config["grid_overlap"] = num_overlap1.Value.ToString();
            plugin.Host.config["grid_sidelap"] = num_sidelap1.Value.ToString();
            ...
            plugin.Host.config["grid_startfrom"] = CMB_startfrom1.Text;
        ...
        private void domainUpDown1_ValueChanged(object sender, EventArgs e)
        {
            ...
            grid = Grid.CreateGrid(list, CurrentState.fromDistDisplayUnit((double) NUM_altitude.Value),
                (double) NUM_Distance1.Value, (double) NUM_spacing.Value, (double) NUM_angle.Value,
                (double) NUM_overshoot1.Value, (double) NUM_overshoot21.Value,
                (Grid.StartPosition) Enum.Parse(typeof (Grid.StartPosition), CMB_startfrom1.Text), false,
                (float) NUM_Lane_Dist.Value, (float) NUM_leadin1.Value);
            ...
            if (chk_crossgrid.Checked)
            {
                ...
                grid.AddRange(Grid.CreateGrid(list, CurrentState.fromDistDisplayUnit((double) NUM_altitude.Value),
                    (double) NUM_Distance1.Value, (double) NUM_spacing.Value, (double) NUM_angle.Value + 90.0,
                    (double) NUM_overshoot1.Value, (double) NUM_overshoot21.Value,
                    Grid.StartPosition.Ponto, false,
                    (float) NUM_Lane_Dist.Value, (float) NUM_leadin1.Value));
            }
            ...
            */
            ...
            if (DistUnits == "Feet")
            {
                ...
                lbl_distbetweenlines.Text = (NUM_Distance1.Value * 3.2808399m).ToString("0.##") + " ft";
            ...
            else
            {
                ...
                lbl_distbetweenlines.Text = NUM_Distance1.Value.ToString("0.##") + " m";
        ...
        void doCalc()
        {
            try
            {
                ...
                int overlap = (int)num_overlap1.Value;
                int sidelap = (int)num_sidelap1.Value;
                ...
                NUM_Distance1.ValueChanged -= domainUpDown1_ValueChanged;

                if (CHK_camdirection.Checked)
                {
                    NUM_spacing.Value = (decimal)((1 - (overlap / 100.0f)) * viewheight);
                    NUM_Distance1.Value = (decimal)((1 - (sidelap / 100.0f)) * viewwidth);
                }
                else
                {
                    NUM_spacing.Value = (decimal)((1 - (overlap / 100.0f)) * viewwidth);
                    NUM_Distance1.Value = (decimal)((1 - (sidelap / 100.0f)) * viewheight);
                }
                NUM_spacing.ValueChanged += domainUpDown1_ValueChanged;
                NUM_Distance1.ValueChanged += domainUpDown1_ValueChanged;
            }
            ...
            if (grid != null && grid.Count > 0)
            {
                ...
                for (int splitno = 0; splitno < NUM_split.Value; splitno++)
                {
                    ...
                    if (CHK_toandland.Checked)
                    {
                        ...
                        {
                            plugin.Host.AddWPtoList(MAVLink.MAV_CMD.LOITER_TO_ALT, 0, 0, 0, 0, plugin.Host.cs.HomeLocation.Lng+0.0025,
                                plugin.Host.cs.HomeLocation.Lat, 100, gridobject);
